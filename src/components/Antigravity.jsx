...
const AntigravityInner = ({
  count = 120, // Reducido de 300 a 120 para mejor rendimiento
  magnetRadius = 10,
  ringRadius = 10,
  waveSpeed = 0.4,
  waveAmplitude = 1,
  ...
  useEffect(() => {
    ...
    if (isLowEnd && count > 100) {
      setActualCount(Math.min(100, count));
    }
  }, [count]);
  ...
  const particles = useMemo(() => {
    ...
    return temp;
  }, [actualCount, viewport.width, viewport.height]);
